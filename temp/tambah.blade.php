        ...
        <div class="col-md-12">
			<div class="portlet box blue-chambray">
				...
				<div class="portlet-body form">
					<!--<form action="/adm/user/cari" class="form-horizontal" method="POST">
						{{ csrf_field() }}
						<div class="form-body">
					...
					<form id="newDataForm" class="form-horizontal" action="/adm/user/tambah" method="POST" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
						...
						<div class="form-body">
							<div class="form-group">
                                ...
                                <div class="col-md-4">
    								<input type="text" name="username" class="form-control input-sm" value="{{ $status ? $user['username'] : $request }}" readonly />
                                </div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Email</label>
                                <div class="col-md-4">
    								<input type="text" name="email" class="form-control input-sm" value="{{ $status ? $user['email'] : '' }}" {{ $status ? 'readonly':'' }}/>
                                </div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Nama</label>
                                <div class="col-md-4">
    								<input type="text" name="name" required="required" class="form-control input-sm" value="{{ $status ? $user['name'] : '' }}" {{ $status ? 'readonly':'' }}/>
                                </div>
							</div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">No Handphone</label>
                                <div class="col-md-4">
                                    <input type="number" name="handphone" required="required" class="form-control input-sm" value="{{ $status ? $user['handphone'] : '' }}" {{ $status ? 'readonly':'' }}/>
                                </div>
                            </div>
							<!--<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    @if($status)
                                    <input type="text" name="bumn" required="required" class="form-control input-sm" value="{{ $status ? $user['bumn_lengkap'] : '' }}" {{ $status ? 'readonly':'' }}/>
                                    @else
						...
						<div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
            						<a href="/adm/user/cari" class="btn red">
