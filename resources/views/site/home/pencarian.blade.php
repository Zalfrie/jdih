...
@section('content')
  ...
  <div class="contentWrapper">
    <div class="container">
      <form name="cariForm" class="form-horizontal clearfix" action="/pencarian" method="get">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="selectJenis" class="col-sm-5 control-label">Jenis</label>
              <div class="col-sm-11">
            ...
            <div class="form-group">
              <label for="selectJenis" class="col-sm-5 control-label">Materi Peraturan</label>
              <div class="col-sm-11">
                <div class="input-group">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="selectTentang" class="col-sm-5 control-label">Tahun</label>
              <div class="col-sm-11">
                 <div class="input-group">
            ...
            <div class="form-group">
              <label for="selectStatus" class="col-sm-5 control-label">Tentang</label>
              <div class="col-sm-11">
                <div class="input-group">
