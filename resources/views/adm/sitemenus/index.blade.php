		...
		<div class="modal-body">
			<div class="row">
				<div class="col-md-12">
					...
					<form id="addMenuForm" class="form-horizontal margin-bottom-40" action="/adm/sitemenu" method="POST" role="form">
    					{{ csrf_field() }}
...
jQuery(document).ready(function() {
    ...
    $("a.editModal").click(function(){
        ...
        $("form", modalElm).attr('action', '/adm/sitemenu/'+id);
