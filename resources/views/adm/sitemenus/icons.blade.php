	...
	<div id="modalIcon" class="modal container fade" tabindex="-1" data-focus-on="input:first">
							...
							<div class="tab-content">
								<div class="tab-pane active fontawesome-demo" id="tab_1_1">
									...
									<div class="row margin-bottom-20">
										<div class="fa-item col-md-3 col-sm-4" data-dismiss="modal">
								...
								<div class="tab-pane" id="tab_1_3">
									<div class="simplelineicons-demo">
										<span class="item-box" data-dismiss="modal">
										<span class="item">
