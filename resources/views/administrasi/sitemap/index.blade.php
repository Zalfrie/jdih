		...
		<div class="modal-body">
			<div class="row">
				<div class="col-md-12">
					...
					<form id="addMenuForm" class="form-horizontal margin-bottom-40" action="/administrasi/sitemap" method="POST" role="form">
    					{{ csrf_field() }}
...
jQuery(document).ready(function() {
    ...
    $('#nestable_menu').nestable({
        ...
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: '/administrasi/sitemap/reorder',
    ...
    $("a.editModal").click(function(){
        ...
        $("form", modalElm).attr('action', '/administrasi/sitemap/'+id);
