        ...
        <div class="col-md-12">
			<div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-book-open"></i> Edit Whitelist
					</div>
				</div>
				<div class="portlet-body form">
                    @include('common.errors')
					<form id="ubahDataForm" class="form-horizontal" action="/administrasi/whitelist/{{ $data->id }}" method="POST" role="form">
                    {{ csrf_field() }}
                        {{ method_field('PUT') }}
						<div class="form-body">
                            <div class="row">
                                <div class="col-md-9">
        							<div class="form-group">
                                        ...
                                        <div class="col-md-10">
        								    <input type="text" name="ip" class="form-control input-sm" value="{{ $data->ip }}" >
                                        </div>
        							</div>
        							<div class="form-group">
        								<label class="col-md-2 control-label">Domain</label>
                                        <div class="col-md-10">
        								    <input type="text" name="domain" class="form-control input-sm" value="{{ $data->domain }}" >
                                        </div>
        							</div>
        							<div class="form-group">
						...
						<div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
        							<a type="button" href="/administrasi/whitelist" class="btn default">Kembali</a>
