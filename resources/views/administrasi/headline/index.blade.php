            ...
            <div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject bold"> Headline</span>
					</div>
					<div class="actions">
						<a type="button" class="btn blue" data-toggle="modal" href="/administrasi/headline/tambah">
    ...
    var oTable = $('#tableData').dataTable({
        ...
        "rowCallback": function( row, data, iDisplayIndex ) {
            ...
            $(row).on('click', '.publish', function () {
                $.ajax({
                    url: "/administrasi/headline/publish",
                    method: "POST",
