        ...
        <div class="col-md-12">
			<div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-book-open"></i> Tambah Headline Baru
					</div>
				</div>
				<div class="portlet-body form">
                    @include('common.errors')
					<form id="newDataForm" class="form-horizontal" action="/administrasi/headline" method="POST" enctype="multipart/form-data" role="form">
                    {{ csrf_field() }}
						<div class="form-body">
                            <div class="row">
                                <div class="col-md-9">
        							<div class="form-group">
                                        ...
                                        <div class="col-md-10">
        								    <input type="text" name="konten" class="form-control input-sm" value="{{ old('judul') }}" >
                                        </div>
        							</div>
        							<div class="form-group">
