            ...
            <div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject bold"> Berita</span>
					</div>
					<div class="actions">
						<a type="button" class="btn blue" data-toggle="modal" href="/administrasi/berita/tambah">
...
jQuery(document).ready(function() {
    ...
    var oTable = $('#tableData').dataTable({
        ...
        "stateSave": true,
        "ajax": {
            "url": '/administrasi/berita/getdatatable',
            "type": "POST"
        },
        "columns": [
            ...
            {data: 'kontenPreview', name: 'kontenPreview'},
        ...
        "rowCallback": function( row, data, iDisplayIndex ) {
            ...
            $(row).on('click', '.publish', function () {
                $.ajax({
                    url: "/administrasi/berita/publish",
                    method: "POST",
