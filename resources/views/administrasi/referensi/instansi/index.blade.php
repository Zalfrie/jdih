            ...
            <div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject bold uppercase"> REFERENSI INSTANSI</span>
					</div>
					<div class="actions">
						<a type="button" class="btn blue" data-toggle="modal" href="/administrasi/referensi/instansi/tambah">
...
jQuery(document).ready(function() {
    ...
    var oTable = $('#tableData').dataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": '/administrasi/referensi/instansi/getdatatable',
            "type": "POST"
        },
        "columns": [
