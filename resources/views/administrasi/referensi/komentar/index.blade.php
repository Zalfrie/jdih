            ...
            <div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject bold uppercase"> REFERENSI Komentar/Review</span>
					</div>
...
jQuery(document).ready(function() {
    ...
    var oTable = $('#tableData').dataTable({
        ...
        "stateSave": true,
        "ajax": {
            "url": '/administrasi/referensi/komentar/getdatatable',
            "type": "POST"
        },
        "columns": [
            {data: null, sortable: false, searchable: false, width: "20px", className: "text-center"},
            {data: 'review', name: 'review'},
            {data: 'review_user', name: 'review_user'},
            {data: 'per_no', name: 'per_no'},
