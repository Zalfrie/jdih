            ...
            <div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject bold uppercase"> REFERENSI STATUS PERATURAN</span>
					</div>
					<div class="actions">
						<a type="button" class="btn blue" data-toggle="modal" href="/administrasi/referensi/status/tambah">
...
jQuery(document).ready(function() {
    ...
    var oTable = $('#tableData').dataTable({
        ...
        "stateSave": true,
        "ajax": {
            "url": '/administrasi/referensi/status/getdatatable',
            "type": "POST"
        },
        "columns": [
