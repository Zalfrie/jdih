            ...
            <div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject bold uppercase"> REFERENSI SUBYEK PERATURAN</span>
					</div>
					<div class="actions">
						<a type="button" class="btn blue" data-toggle="modal" href="/administrasi/referensi/subyek/tambah">
...
jQuery(document).ready(function() {
    ...
    var oTable = $('#tableData').dataTable({
        ...
        "stateSave": true,
        "ajax": {
            "url": '/administrasi/referensi/subyek/getdatatable',
            "type": "POST"
        },
        "columns": [
