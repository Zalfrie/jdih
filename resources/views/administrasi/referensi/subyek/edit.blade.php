        ...
        <div class="col-md-12">
			<div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-book-open"></i> Ubah Referensi Subyek
					</div>
				</div>
				<div class="portlet-body form">
                    @include('common.errors')
					<form id="ubahDataForm" class="form-horizontal" action="/administrasi/referensi/subyek/{{ $data->subyek_id }}" method="POST" role="form">
                    {{ csrf_field() }}
                        {{ method_field('PUT') }}
						<div class="form-body">
							<div class="form-group">
                                ...
                                <div class="col-md-4">
    								<input type="text" name="subyek" required="required" class="form-control input-sm" value="{{ $data->subyek }}" />
                                </div>
							</div>
						</div>
