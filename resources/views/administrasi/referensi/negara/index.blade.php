            ...
            <div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject bold uppercase"> REFERENSI NEGARA</span>
					</div>
					<div class="actions">
						<a type="button" class="btn blue" data-toggle="modal" href="/administrasi/referensi/negara/tambah">
...
jQuery(document).ready(function() {
    ...
    var oTable = $('#tableData').dataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": '/administrasi/referensi/negara/getdatatable',
            "type": "POST"
        },
        "columns": [
