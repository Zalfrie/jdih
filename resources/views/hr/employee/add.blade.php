        ...
        <div class="col-md-12">
			<div class="portlet box blue-chambray">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-users"></i> New Employee Form
					</div>
				</div>
				<div class="portlet-body form">
                    @include('common.errors')
					<form id="EmployeeForm" class="form-horizontal" action="/hr/employee" method="POST" enctype="multipart/form-data" role="form">
                    {{ csrf_field() }}
						<div class="form-body">
							<div class="form-group">
								<label class="col-md-3 control-label">Employee Number</label>
                                <div class="col-md-3">
								    <input type="text" name="empl_numb" class="form-control input-sm" value="{{ old('empl_numb') }}" />
                                </div>
							</div>
							<div class="form-group">
